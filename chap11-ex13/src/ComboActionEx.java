...
public class ComboActionEx extends JFrame {
	private String[] fruits = { "apple", "banana", "kiwi", "mango" }; // 콤보박스의
																		// 아이템
	...
	private JComboBox<String> strCombo = new JComboBox<String>(fruits); // 문자열
																		// 콤보박스
	...
	public ComboActionEx() {
		...
		strCombo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JComboBox<String> cb = (JComboBox<String>) e.getSource(); // Action
																			// 이벤트가
																			// 발생한
																			// 콤보박스
																			// 알아내기
