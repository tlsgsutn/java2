...
public class ImagePracticeFrame extends JFrame {
	...
	class MyPanel extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			g.drawImage(img, panelWidth / 2 + 5, 0, panelWidth, panelHeight / 2 - 5, imgWidth / 2, 0, imgWidth,
					imgHeight / 2, this);
			g.drawImage(img, 0, panelHeight / 2 + 5, panelWidth / 2 - 5, panelHeight, 0, imgHeight / 2, imgWidth / 2,
					imgHeight, this);
			g.drawImage(img, panelWidth / 2 + 5, panelHeight / 2 + 5, panelWidth, panelHeight, imgWidth / 2,
					imgHeight / 2, imgWidth, imgHeight, this);
		}
	}
