...
public class GraphicsDrawLineMouseEx extends JFrame {
	...
	// 선을 그릴 수 있는 패널을 구현한다.
	// 이 패널에 Mouse 리스너를 구현하다.
	class MyPanel extends JPanel {
		// 그려진 선을 모두 저장하기 위해 시작점은 vStart에
		// 끝점은 vEnd 벡터에 각각 저장한다.
		private Vector<Point> vStart = new Vector<Point>(); // Point만 저장하는 제네릭
															// 벡터
		...
		public void paintComponent(Graphics g) {
			...
			// 벡터의 크기만큼 루프만큼 루프 돌면서 선을 그린다.
			for (int i = 0; i < vStart.size(); i++) { // vStart 벡터의 크기는 만들어진 선의
														// 개수와 동일
